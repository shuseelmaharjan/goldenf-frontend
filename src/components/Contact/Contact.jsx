    ...
    <div style={{ marginTop: '120px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)' }} className="container py-3">
      ...
      <div className="row">
        <div className="col-md-6 mb-3">
          <div className="row">
            <h4 className="ml-3">Get in Touch with Us</h4>
            <div className="col-12 mt-2">
              <div className="d-flex align-items-center">
                <span className="icon mr-2"><i className="fa-solid fa-envelope"></i></span>
                <a href="mailto:info@goldenfutureinstitute.com.np" style={{ textDecoration: 'none', color: 'black' }}>info@goldenfutureinstitute.com.np</a>
              </div>
              <div className="d-flex align-items-center mt-2">
                <span className="icon mr-2"><i className="fa-solid fa-phone"></i></span>
                <a href="tel:+977-1-5108166" style={{ textDecoration: 'none', color: 'black' }}>01-5108166</a>
              </div>
              <div className="d-flex align-items-center mt-2">
                <span className="icon mr-2"><i className="fa-solid fa-location-dot"></i></span>
                <span>Satungal, Chandragiri-11, Kathmandu</span>
              </div>
            </div>
          </div>
